        ...
        <div className="contact-grid">
          ...
          <div className="contact-info">
            ...
            <div className="contact-item">
              ...
              <div className="contact-details">
                <h3>நிறுவனம் / Company</h3>
                <p>
                  News Ghuru is a digital media brand operated by Ghurudeva
          ...
          <div className="contact-form-container">
            <h3>செய்தி அனுப்பவும் / Send Message</h3>
            {submitted && (
              <div className="alert-success">
                உங்கள் செய்தி வெற்றிகரமாக அனுப்பப்பட்டது! நன்றி. (Message sent successfully! Thank you.)
              </div>
            )}
